...
{
    /// <summary>
    /// 一天中的时间。忠实移植 UE <c>ANarrativeGameState</c> 的时钟制式：
    ...
    {
        /// <summary>当前一天中的时间，落在 [0, 2400)。对应 UE <c>ANarrativeGameState::TimeOfDay</c>。</summary>
        float TimeOfDay { get; }

        /// <summary>总累计时间，2400 = 一天，不回绕。对应 UE <c>AccumulatedTime</c>。</summary>
